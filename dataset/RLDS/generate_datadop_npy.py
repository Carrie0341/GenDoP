...
Usage:
    ...
    python generate_datadop_npy.py --data_root ./DATA --output_dir ./DATA/datadop-npy/splits --val_split 0.1 --test_split 0.1 --seed 42
    
    # Test mode with 20 random samples
    python generate_datadop_npy.py --data_root ./DATA --output_dir ./DATA/datadop-npy-test/splits --test_samples 20 --seed 42
"""
